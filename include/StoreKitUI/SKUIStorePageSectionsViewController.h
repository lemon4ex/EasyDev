 ...
 * on Friday, November 7, 2014 at 1:48:32 AM Eastern European Standard Time
...
@protocol SKUIStorePageSectionsDelegate,SKUIStorePageCollectionViewDelegate,SKUILayoutCacheDelegate,SKUIProductPageOverlayDelegate;
...
@property (assign,nonatomic,weak) id<SKUIStorePageSectionsDelegate> delegate;                          //@synthesize delegate=_delegate - In the implementation block
